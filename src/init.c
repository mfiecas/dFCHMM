...
extern SEXP _dFCHMM_get_emission_distribution(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_dFCHMM_get_emission_distribution", (DL_FUNC) &_dFCHMM_get_emission_distribution, 8},
